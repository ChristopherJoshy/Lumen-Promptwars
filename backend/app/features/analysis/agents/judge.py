...
_SYSTEM = (
    ...
    "AND perceptual agreement -> likely_synthetic; spectrum >= 0.6 with clean "
    "ELA (fully synthetic fingerprint, no splice) also supports "
    "likely_synthetic; spectrum >= 0.5 plus dct >= 0.4 plus perceptual "
    "artifact_score >= 0.35 (three soft agrees) -> likely_synthetic; tool "
    "and perceptual signals disagreeing with no winner "
    "-> insufficient_evidence with the conflict named explicitly; verified "
    "means no manipulation signs and no "
